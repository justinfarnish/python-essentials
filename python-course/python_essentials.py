...
# 
# **Course Materials:** https://courses.dataschool.io/courses/python-essentials-for-data-scientists
# 
...
# pandas is part of the Anaconda distribution (but not the Python Standard Library)
import pandas as pd
